...
const Navbar = () => {
    return (
        <div className='bg-gray-900'>
            <div className="bg-gray-900 container w-[90%] mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center justify-between">
                <Link href={`/`} className="flex title-font font-medium items-center text-white mb-4 md:mb-0">
                    <span className={` ml-3 text-[1.95rem] font-bold text-yellow-100`}>Hunting Coder</span>
                </Link>
                <nav className=" flex flex-wrap items-center text-base justify-center list-none md:space-x-8">
