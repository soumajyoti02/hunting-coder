                    ...
                    <div className="flex flex-wrap -m-4">
                        ...
                        <div className="p-4 md:w-1/3">
                            <div className="flex rounded-lg h-full bg-gray-800 bg-opacity-60 p-8 flex-col">
                                ...
                                <div className="flex-grow">
                                    <p className="leading-relaxed text-base">If you're looking to create a dynamic application to help your business succeed, our team of expert coders can help. We specialize in developing customized applications that are tailored to your unique needs, whether you're looking to create a mobile app, a web-based application, or a desktop solution. We work closely with you throughout the development process to ensure that your application meets your business goals and exceeds your expectations. With our expertise and experience, we can help you bring your application vision to life.</p>
                                    <a className="mt-3 text-indigo-400 inline-flex items-center">Learn More
                                        <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-4 h-4 ml-2" viewBox="0 0 24 24">
                                            <path d="M5 12h14M12 5l7 7-7 7"></path>
                                        </svg>
