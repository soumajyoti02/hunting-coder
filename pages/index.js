  ...
  return (
    <>
      ...
      <main className='box-border bg-gray-900  w-screen pb-10'>
        ...
        <section className=' w-[90vw] m-auto  flex flex-wrap  justify-around items-center bg-gray-900 pt-10 pb-10 '>
          <div className="w-[90vw] m-auto md:w-[50%] h-[36rem] space-y-8 flex flex-col justify-center">
            <h2 className={`text-4xl md:text-7xl font-bold text-white pt-1 box-border text-center md:text-left`}>&lt;Hunting Coder/&gt;</h2>

            <h2 className={`text-white text-lg text-semibold font-mono md:w-11/12 text-center md:text-left`}>Welcome to our website, where we provide innovative coding solutions to help businesses and individuals achieve their goals. Our team of expert coders specializes in creating customized solutions that are tailored to your unique needs, whether you&apos;re looking to streamline your operations, automate processes, or create dynamic applications.
          ...
          <img src={`/homeimg.jpg`} width={637} height={198} className={`rounded-3xl mt-10 lg:mt-0 `} alt='my-images'></img>
        </section>
        <section className="blogpage flex  flex-wrap-reverse justify-center lg:justify-between items-center w-[90%] m-auto mb-10 lg:mb-0">
          <img src={`/blog.jpg`} width={658} height={320} className={`rounded-3xl h-[222px]  md:h-[320px] mt-10 md:mt-0`} alt='my-images'></img>
          <PopularBlog />
        </section>
      </main >
    </>
